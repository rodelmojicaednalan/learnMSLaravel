            ...
            <div class="icon-action">
                <div class="dropdown dropdown-style-1">
                    ...
                    <div class="dropdown-menu" aria-labelledby="icon-action">
                        ...
                        <a class="dropdown-item class_action" data-action="delete"  href="javascript:void(0);" data-toggle="modal" data-id="{{ $class->id }}" data-target="#delete-class-overlay">Delete</a>
                    </div>
                </div>
            </div><!-- End icon action -->
        </div>
