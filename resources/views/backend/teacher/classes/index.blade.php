                            ...
                            <div class="col-md-4 my-2 my-md-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <select class="form-control" id="kt_datatable_search_role">
                                        ...
                                        <option value="1">Speech & Drama</option>
                            ...
                            <div class="col-md-4 my-2 my-md-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <select class="form-control" id="kt_datatable_search_teacher">
                                        <option value="">All</option>
                                        <option value="1">Queenie</option>
                                        <option value="2">Jamille</option>                                      
                                    </select>
                                </div>
                            </div>
                        </div>
...
function loadSchedules(id)
{
     $.ajax({
        type:'POST',
        url: 'private-classes/ajax/load_schedules',        
        data:{
            id: id,
           _token: CSRF_TOKEN,
        },
...
$.ajax({
    type:'POST',
    url: 'private-classes/ajax/update_single_schedule',
    dataType:"json",
    data: $(this).serialize(),
    success:function(data)
    {
...
$(document).on('click','.action_user',function(e)
{
 ...
 if(action == "add")
 {
    ...
    $('#form_txt').text("Add New Private Class");
    $('#btnAdd').show();
    $('#btnUpdate').hide();
 }
 ...
 if(action == "update")
 {
    ...
    $('#form_txt').text("Update Private Class");
    var id = $(this).attr('data-id');

    $.ajax({
        type:'POST',
        url: 'private-classes/ajax/load_single_class',
        dataType:"json",
        data:{
            id: id,
           _token: CSRF_TOKEN,
...
function load_levels(subject_id) 
{
    ...
    $("#txt_level").empty();
       ...
       $.ajax({
           type:'POST',
           url: 'private-classes/ajax/load_levels',
           data:{ 
            _token:CSRF_TOKEN,
            id:subject_id,
           },
...
$.ajax({
        type:'POST',
        url: 'private-classes/ajax/add_new_class',
        dataType:"json",
        data:{
                ...
                template: function(row) {
                    ...
                    // console.log(row['dates']);
                     for (var x=0; x < tmp_arr.length; x++) { 
                            ...
                            zoom_url = "private-classes/meeting?name="+  zoom_name +"&mn="+ meeting_number + "&email="+ zoom_email +  '&pwd=&role=1&lang=en-US&signature='+ res.result +'&china=0&apiKey='+ API_KEY;
