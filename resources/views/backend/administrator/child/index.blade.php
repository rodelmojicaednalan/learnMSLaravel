    ...
    var demo = function() {
         ...
         datatable = $('#kt_datatable').KTDatatable({
            ...
            }, 
            {
                ...
                title: 'Birthdate',
                template: function(row) {
                    return moment(row.birthdate).format('DD MMMM YYYY');
                }
            },{
                field: 'Actions',
                title: 'Actions',
                ...
                template: function() {
                    ...
                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
                                <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-04-19-122603/theme/html/demo1/dist/../src/media/svg/icons/Map/Position.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                <rect x="0" y="0" width="24" height="24"/>\
