        ...
        <div class="modal-body">
           ...
           <input type="hidden" id="txt_parentid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="child_subject">
                </div>
...
$('#update-subject-level-form').on('submit',function(e){
                        ...
                        $.ajax({
                                type:'POST',
                                url: '/administrator/settings/subjects/ajax/update_level',
                                dataType:"json",
                                data: $(this).serialize(),
                                success:function(data)
                                {
...
$(document).on('click','.action_user',function(e)
{
 ...
 if(action == "edit_child")
 {
    ...
    $.ajax({
        type:'POST',
        url: 'subjects/ajax/load_single_subject',
        dataType:"json",
        data:{
            id: id,
           _token: CSRF_TOKEN,
        ...
        success:function(data)
        {
            ...
            $('#child_subject').val(data.subject);
...
var subject = $('#child_subject').val();
var parent_id = $('#txt_parentid').val();

$.ajax({
        type:'POST',
        url: 'subjects/ajax/add_new_child',
        dataType:"json",
        data:{
            subject: subject,
            subject_id:0,
...
$.ajax({
        type:'POST',
        url: 'subjects/ajax/add_new_subject',
        dataType:"json",
        data:{
            subject: subject,
            subject_id:0,
...
$.ajax({
        type:'POST',
        url: 'subjects/ajax/btnSaveLevel',
        dataType:"json",
        data:{
...
$.ajax({
        ...
        success:function(data)
        {
            ...
            html: err_txt,
                    ...
                    source: {
                        read: {
                            url: 'subjects/ajax/subjects_list',
                            headers: {
