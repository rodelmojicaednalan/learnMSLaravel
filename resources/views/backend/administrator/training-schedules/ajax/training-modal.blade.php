<div class="card card-custom">
   <div class="card-header card-header-tabs-line">
      <div class="card-title">
         <h3 class="card-label"><span class="text-muted">Training ID:</span> {{ $training->id }} </h3>
      </div>
      <div class="card-toolbar">
         <ul class="nav nav-tabs nav-bold nav-tabs-line"">
            <li class="nav-item">
               ...
               {{-- <a class="nav-link active" data-toggle="tab" href="#training_sched_list">Time Slots</a> --}}
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#training_add_schedule">
                        ...
                        <span class="nav-text action_schedule" data-action="add_new_schedule">Add Time Slot</span>
                </a>
               {{-- <a class="nav-link" data-toggle="tab" href="#training_add_schedule">Add Time Slot</a> --}}
            </li>            
         </ul>
      </div>
   </div>
   <div class="card-body">
      <div class="tab-content">
         ...
         <div class="tab-pane fade" id="training_add_schedule" role="tabpanel" aria-labelledby="training_add_schedule">
            <form class="form" id="add-training-schedule-form">
                @csrf
                   <div class="card-body">
                   ...
                   <div class="card-footer">
                      <div class="row">
                         ...
                         <div class="col-lg-6">
                            ...
                            <button type="submit" class="btn btn-success mr-2">Add Time Slot</button>
...
<script type="text/javascript">
        ...
        $(document).ready(function(){
                ...
                $('#add-training-schedule-form').on('submit',function(e){
                        e.preventDefault();
                        
                        $.ajax({
                            
                                type:'POST',
                                url: '/administrator/training-schedules/ajax/add_new_schedule',
                                dataType:"json",
                                data: $(this).serialize(),
