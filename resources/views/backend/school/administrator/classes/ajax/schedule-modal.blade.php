<div class="card card-custom">
   <div class="card-header card-header-tabs-line">
      <div class="card-title">
         <h3 class="card-label"><span class="text-muted">Class ID:</span> {{ $class->id }} </h3>
      </div>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','.action_schedule',function(e){
            ...
            if(action == "edit_schedule")
            {
                ...
                $('#start_date2').datepicker("setDate", new Date(start_date) );
        ...
        $('#add-class-schedule-form').on('submit',function(e){
            ...
            $.ajax({
                ...
                type:'POST',
                url: 'classes/ajax/add_new_schedule',
                dataType:"json",
                data: $(this).serialize(),
