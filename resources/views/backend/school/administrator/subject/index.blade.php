    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Manage Subjects
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control clear_data" id="txt_subject" placeholder="Subject">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Subscription Fee</label>
                <input type="number" class="form-control clear_data" id="txt_fee"  value="0.00" placeholder="Subscription Fee">
            </div>
            ...
            columns: [{
                    ...
                    template: function(row) {
                        return '\
                            ...
                            <a href="javascript:;" class="btn btn-sm btn-clean btn-icon action_user" data-action="delete_subject" data-id="'+ row.id +'" title="Delete">\
                                <span class="svg-icon svg-icon-md">\
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                            <rect x="0" y="0" width="24" height="24"/>\
