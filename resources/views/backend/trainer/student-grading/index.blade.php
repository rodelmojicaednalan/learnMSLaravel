    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Grading to conduct
                </h3>
            </div>
         ...
         datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [{
                ...
                template: function(row) {
                    return moment(row.schedule_date).format('DD MMMM YYYY');
                }
            },
            {
                field: 'zxc',
                title: 'time',
                template: function(row) {
                   return tConvert(row.start_time) + " - " + tConvert(row.end_time);
                }
            }, 
            {
                field: 'parent_name',
