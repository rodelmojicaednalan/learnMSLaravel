...
@section('content')
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Manage Child
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
                    ...
                    <input type="text" class="form-control clear_data" id="txt_middle" placeholder="Middle Name">
                    </div>
                    ...
                    <input type="text" class="form-control clear_data" id="birthdate" readonly="readonly" placeholder="Select date" />
                    </div>
...
$(document).on('click','.action_user',function(e)
{
 ...
 if(action == "update")
 {
    ...
    $('#form_txt').text("Update Child");
    var id = $(this).attr('data-id');

    $.ajax({
        type:'POST',
        url: 'child/ajax/load_single_child',
        dataType:"json",
        data:{
            id: id,
           _token: CSRF_TOKEN,
        ...
        success:function(data)
        {
            ...
            $('#txt_first').val(data.firstname);
            $('#txt_first').attr("child_id", data.id);
            $('#txt_middle').val(data.middlename);
            $('#txt_last').val(data.lastname);
...
var firstname = $('#txt_first').val();
var id =$('#txt_first').attr('child_id');
var middlename = $('#txt_middle').val();
var lastname = $('#txt_last').val();
var birthdate = $('#birthdate').val();
