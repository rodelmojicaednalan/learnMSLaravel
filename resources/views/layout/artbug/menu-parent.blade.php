...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 211px; overflow: hidden;">
        ...
        <ul class="menu-nav ">
           <li class="menu-item @if (Request::is('parent/dashboard*')) menu-item-open menu-item-active @endif" aria-haspopup="true">
              <a href="{{ url('parent/dashboard') }}" class="menu-link ">
                 <i class="menu-icon flaticon2-layers-2"></i>
                 <span class="menu-text">Dashboard</span>
              </a>
           </li>
            <li class="menu-item @if (Request::is('parent/classes*')) menu-item-open menu-item-active @endif" aria-haspopup="true">
                <a href="{{ url('parent/classes') }}" class="menu-link ">
                    <i class="menu-icon fas fa-book"></i><span class="menu-text">Public Classes</span>
                </a>
            </li>
            <li class="menu-item @if (Request::is('parent/payment-transactions*')) menu-item-open menu-item-active @endif" aria-haspopup="true">
                <a href="{{ url('parent/payment-transactions') }}" class="menu-link ">
            ...
            <li class="menu-item @if (Request::is('parent/child*')) menu-item-open menu-item-active @endif" aria-haspopup="true">
                <a href="{{ url('parent/child') }}" class="menu-link ">
                    <i class="menu-icon fas fa-wallet"></i><span class="menu-text">Childrens</span>
                </a>
            </li>
        </ul>
